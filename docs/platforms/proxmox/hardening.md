...
- restrict the management interface to a dedicated management network
...
- review firewall policy between management and other zones
...
- review cluster node naming, storage naming, and bridge naming conventions
...
- management network access is restricted
